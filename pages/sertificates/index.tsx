		...
		<div className="h-full bg-primary/30 py-36 flex items-center">
			...
			<div className="container mx-auto">
				<div className="flex flex-col xl:flex-row gap-x-8 items-center">
					<div className="text-center flex xl:w-[30vw] flex-col lg:text-center xl:text-left mb-4 xl:mb-0 z-20">
						<motion.h2
						...
						>
							Сертификаты получены в ходе обучения на платформе
							The Rolling Scopes School. RS School — это
							бесплатная образовательная программа, проводимая
							сообществом разработчиков The Rolling Scopes с 2013
							года. Так же имеется сертификат моего уровня
							владения английским.
						</motion.p>
					</div>
					<motion.div
